...
Para que sirve: carga cada linea de la salida de find en un elemento del array 'archivos'. La opcion `-t` elimina el salto de linea (newline) de cada elemento.
...
Para que sirve: alinea automaticamente las columnas del texto sin tener que calcular los anchos manualmente.
